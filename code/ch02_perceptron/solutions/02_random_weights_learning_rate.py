...
x_min_1 = -2
y_min_1 = (-(randw_params_1['weights'][0] * x_min) / randw_params_1['weights'][1] -
               (randw_params_1['bias'] / randw_params_1['weights'][1]))

x_max_1 = 2
y_max_1 = (-(randw_params_1['weights'][0] * x_max) / randw_params_1['weights'][1] -
           (randw_params_1['bias'] / randw_params_1['weights'][1]))
...
x_min_2 = -2
y_min_2 = (-(randw_params_2['weights'][0] * x_min) / randw_params_2['weights'][1] -
            (randw_params_2['bias'] / randw_params_2['weights'][1]))

x_max_2 = 2
y_max_2 = (-(randw_params_2['weights'][0] * x_max) / randw_params_2['weights'][1] -
            (randw_params_2['bias'] / randw_params_2['weights'][1]))
